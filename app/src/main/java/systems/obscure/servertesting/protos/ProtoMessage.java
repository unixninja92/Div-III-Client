...
public final class ProtoMessage extends Message {
  ...
  public static final UnsignedLong DEFAULT_IN_REPLY_TO = UnsignedLong.valueOf(0);
  public static final List<UnsignedLong> DEFAULT_ALSO_ACK = Collections.emptyList();
  ...
  public final UnsignedLong in_reply_to;
  ...
  public final List<UnsignedLong> also_ack;
  ...
  public ProtoMessage(UnsignedLong id, Long time, ByteString body, Encoding body_encoding, ByteString my_next_dh, UnsignedLong in_reply_to, List<UnsignedLong> also_ack, List<Attachment> files, List<Detachment> detached_files, Integer supported_version) {
    this.id = id;
    this.time = time;
    this.body = body;
  ...
  public static final class Builder extends Message.Builder<ProtoMessage> {
    ...
    public UnsignedLong in_reply_to;
    public List<UnsignedLong> also_ack;
     ...
     * sent by the recipient.
     */
    public Builder in_reply_to(UnsignedLong in_reply_to) {
      this.in_reply_to = in_reply_to;
      return this;
    }
     ...
     * acknowledged by this message.
     */
    public Builder also_ack(List<UnsignedLong> also_ack) {
  ...
  public static final class Detachment extends Message {
    ...
    public static final String DEFAULT_FILENAME = "";
    public static final UnsignedLong DEFAULT_SIZE = UnsignedLong.valueOf(0);
    public static final UnsignedLong DEFAULT_PADDED_SIZE = UnsignedLong.valueOf(0);
    public static final UnsignedInteger DEFAULT_CHUNK_SIZE = UnsignedInteger.valueOf(0);
    ...
    public final UnsignedLong size;

    @ProtoField(tag = 3, type = UINT64, label = REQUIRED)
    public final UnsignedLong padded_size;

    @ProtoField(tag = 4, type = UINT32, label = REQUIRED)
    public final UnsignedInteger chunk_size;
    ...
    public Detachment(String filename, UnsignedLong size, UnsignedLong padded_size, UnsignedInteger chunk_size, ByteString key, String url) {
      this.filename = filename;
      this.size = size;
    ...
    public static final class Builder extends Message.Builder<Detachment> {
      ...
      public UnsignedLong padded_size;
      public UnsignedInteger chunk_size;
      ...
      public Builder size(UnsignedLong size) {
        this.size = size;
        return this;
      }

      public Builder padded_size(UnsignedLong padded_size) {
        this.padded_size = padded_size;
        return this;
      }

      public Builder chunk_size(UnsignedInteger chunk_size) {
        this.chunk_size = chunk_size;
        return this;
      }
