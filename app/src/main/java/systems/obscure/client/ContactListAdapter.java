 ...
 */
public class ContactListAdapter extends ArrayAdapter<Contact>{ //implements AbsListView.RecyclerListener {
...
//  private final ThreadDatabase threadDatabase;
  ...
  public ContactListAdapter(Context context, ArrayList<Contact> contactList, MasterSecret masterSecret) {
