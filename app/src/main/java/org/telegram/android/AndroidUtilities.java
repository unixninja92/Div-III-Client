...
public class AndroidUtilities {
    ...
    static {
        density = Globals.applicaiontContext.getResources().getDisplayMetrics().density;
        checkDisplaySize();
    }
    ...
    public static Typeface getTypeface(String assetPath) {
        synchronized (typefaceCache) {
            if (!typefaceCache.containsKey(assetPath)) {
                try {
                    Typeface t = Typeface.createFromAsset(Globals.applicaiontContext.getAssets(), assetPath);
...
//                    FileLog.e("Typefaces", "Could not get typeface '" + assetPath + "' because " + e.getMessage());
    ...
    public static void checkDisplaySize() {
        try {
            WindowManager manager = (WindowManager)Globals.applicaiontContext.getSystemService(Context.WINDOW_SERVICE);
            if (manager != null) {
...
//    }
    ...
    public static boolean isTablet() {
        if (isTablet == null) {
            isTablet = Globals.applicaiontContext.getResources().getBoolean(R.bool.isTablet);
        }
        return isTablet;
    }
...
//    }
    ...
    public static int getCurrentActionBarHeight() {
        if (isTablet()) {
            return dp(64);
        } else if (Globals.applicaiontContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            return dp(48);
        } else {
            return dp(56);
        }
    ...
    public static Point getRealScreenSize() {
        ...
        try {
            WindowManager windowManager = (WindowManager) Globals.applicaiontContext.getSystemService(Context.WINDOW_SERVICE);
