...
public abstract class BaseSectionsAdapter extends ArrayAdapter<Contact> {//BaseFragmentAdapter {
    ...
    public BaseSectionsAdapter(Context context, int resource) {
        super(context, resource);
        cleanupCache();
    }

    public BaseSectionsAdapter(Context context, int resource, Contact[] objects) {
