...
public class AsymmetricMasterCipher {
  ...
  public String decryptBody(String body) throws IOException, InvalidMessageException {
    try {
      ...
      byte[][]  parts          = Util.split(combined, org.thoughtcrime.securesms.crypto.PublicKey.KEY_SIZE, combined.length - org.thoughtcrime.securesms.crypto.PublicKey.KEY_SIZE);
      org.thoughtcrime.securesms.crypto.PublicKey theirPublicKey = new org.thoughtcrime.securesms.crypto.PublicKey(parts[0], 0);
  ...
  public String encryptBody(String body) {
    try {
      ...
      org.thoughtcrime.securesms.crypto.PublicKey ourPublicKey       = new PublicKey(31337, ourKeyPair.getPublicKey());
