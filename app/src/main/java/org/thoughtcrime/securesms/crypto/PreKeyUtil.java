...
public class PreKeyUtil {
  ...
  public static List<PreKeyRecord> generatePreKeys(Context context, org.thoughtcrime.securesms.crypto.MasterSecret masterSecret) {
  ...
  public static SignedPreKeyRecord generateSignedPreKey(Context context, org.thoughtcrime.securesms.crypto.MasterSecret masterSecret,
  ...
  private static int getNextPreKeyId(Context context) {
    try {
      ...
      if (!nextFile.exists()) {
        ...
        PreKeyIndex       index  = null;//JsonUtils.fromJson(reader, PreKeyIndex.class);
        reader.close();
  ...
  private static int getNextSignedPreKeyId(Context context) {
    try {
      ...
      if (!nextFile.exists()) {
        ...
        InputStreamReader reader = new InputStreamReader(new FileInputStream(nextFile));
        SignedPreKeyIndex index  = null;//JsonUtils.fromJson(reader, SignedPreKeyIndex.class);
        reader.close();
