...
public class MasterSecretUtil {
                                                                 ...
                                                                 MasterSecret masterSecret)
  {
    try {
      ...
      if (masterSecret != null) {
        org.thoughtcrime.securesms.crypto.MasterCipher masterCipher = new org.thoughtcrime.securesms.crypto.MasterCipher(masterSecret);
  ...
  public static AsymmetricMasterSecret generateAsymmetricMasterSecret(Context context,
                                                                      MasterSecret masterSecret)
  {
    org.thoughtcrime.securesms.crypto.MasterCipher masterCipher = new MasterCipher(masterSecret);
