...
public class MasterSecret implements Parcelable {
  ...
  public static final Creator<org.thoughtcrime.securesms.crypto.MasterSecret> CREATOR = new Creator<org.thoughtcrime.securesms.crypto.MasterSecret>() {
    @Override
    public org.thoughtcrime.securesms.crypto.MasterSecret createFromParcel(Parcel in) {
      return new org.thoughtcrime.securesms.crypto.MasterSecret(in);
    }

    @Override
    public org.thoughtcrime.securesms.crypto.MasterSecret[] newArray(int size) {
      return new org.thoughtcrime.securesms.crypto.MasterSecret[size];
    }
  };
  ...
  public org.thoughtcrime.securesms.crypto.MasterSecret parcelClone() {
    ...
    org.thoughtcrime.securesms.crypto.MasterSecret that = (org.thoughtcrime.securesms.crypto.MasterSecret)thatParcel.readValue(org.thoughtcrime.securesms.crypto.MasterSecret.class.getClassLoader());
