...
public class SaveAttachmentTask extends ProgressDialogAsyncTask<org.thoughtcrime.securesms.util.SaveAttachmentTask.Attachment, Void, Integer> {
  private static final String TAG = org.thoughtcrime.securesms.util.SaveAttachmentTask.class.getSimpleName();
  ...
  @Override
  protected Integer doInBackground(org.thoughtcrime.securesms.util.SaveAttachmentTask.Attachment... attachments) {
    ...
    try {
      ...
      InputStream inputStream = null;// PartAuthority.getPartStream(context, masterSecret, attachment.uri);
